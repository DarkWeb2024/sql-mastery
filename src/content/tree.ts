...
const sqlRoot: TreeNode = {
  ...
  children: [
    ...
    },
    {
      ...
      prerequisites: ['joins'],
      children: [
        { id: 'scalar-subquery', title: 'Scalar subqueries', difficulty: 'medium', estMinutes: 10, interviewImportance: 'medium' },
        { id: 'in-subquery', title: 'IN / EXISTS subqueries', difficulty: 'hard', estMinutes: 12, interviewImportance: 'high' },
        { id: 'correlated-subquery', title: 'Correlated subqueries', difficulty: 'hard', estMinutes: 14, interviewImportance: 'high', prerequisites: ['in-subquery'] },
      ],
    },
    {
      id: 'cte',
      ...
      children: [
        { id: 'basic-cte', title: 'Basic CTEs', difficulty: 'hard', estMinutes: 12, interviewImportance: 'high' },
        { id: 'recursive-cte', title: 'Recursive CTEs', difficulty: 'expert', estMinutes: 18, interviewImportance: 'medium', prerequisites: ['basic-cte'] },
      ],
    },
    {
      id: 'window',
      ...
      children: [
        { id: 'over-partition', title: 'OVER and PARTITION BY', difficulty: 'hard', estMinutes: 14, interviewImportance: 'high' },
        { id: 'ranking', title: 'ROW_NUMBER, RANK, DENSE_RANK', difficulty: 'hard', estMinutes: 14, interviewImportance: 'high', prerequisites: ['over-partition'] },
        { id: 'lag-lead', title: 'LAG and LEAD', difficulty: 'expert', estMinutes: 14, interviewImportance: 'high', prerequisites: ['over-partition'] },
        { id: 'running-totals', title: 'Running totals and moving averages', difficulty: 'expert', estMinutes: 16, interviewImportance: 'medium', prerequisites: ['over-partition'] },
      ],
    },
    {
      id: 'set-ops',
